...
console.log('All invalid credit numbers: ');
// Functions below:
function validateCred(arr) {
  ...
  if(arr.length % 2 === 1) result.unshift(arr[0]);
  return result.reduce((total, value, index, arr) => {
    return total + value;
  }) % 10;
}
function findInvalidCards(nestedArr) {
  ...
  return idInvalidCardCompanies(invalidNestedArr);
}
